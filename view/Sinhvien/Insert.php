...
<h2><span><a href="admin.php?mod=sinhvien&act=insert">Thêm Sinh vien</a></span></h2>
  <p>
  	<form class="form" method="post" action="admin.php?mod=sinhvien&act=insert" enctype="multipart/form-data">
        <p><label>Ma sinh vien (*)</label><input type="text" name="txtMaSV" id="txtMaSV" /></p>
        <p><label>Tên sinh vien (*)</label><input type="text" name="txtHoten" id="txtHoten" /></p>
        <p><label>Ngay sinh </label><input type="date" name="txtNgaysinh" id="txtNgaysinh" /></p>
