...
<form action="admin.php?mod=sinhvien&act=edit&id=<?php echo $id; ?>" method="post" class="form" enctype="multipart/form-data">
    ...
    <div class = "form-group">
		...
		<input class="form-control" type="text" name="txtNgaysinh" id="txtNgaysinh" value="<?php echo $row['Ngaysinh']; ?>"/>
	</div>
    <div class = "form-group">
		<label>Email</label>
		<input class="form-control" type="text" name="txtEmail" id="txtEmail" value="<?php echo $row['Email']; ?>"/>
	</div>
	<div class = "form-group">
        <label>Lớp (*)</label>
